...
public class ADMSFrame extends JFrame {
    ...
    private void setMyButtons() {
        panel = new JPanel();
        JButton patientManageButton = new JButton("患者信息管理");
        JButton clinicalVisitManageButton = new JButton("临床数据管理");
...
//            PatientManageUI pui = new PatientManageUI();
//            pui.setVisible(true);
...
//            ClinicalVisitManageUI cui = new ClinicalVisitManageUI();
//            cui.setVisible(true);
//            cui.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        }));
