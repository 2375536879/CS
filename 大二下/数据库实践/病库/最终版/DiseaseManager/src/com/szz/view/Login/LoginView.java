...
import com.szz.view.Login.ADMSDemo;
...
public class LoginView extends JFrame {
    ...
    public void createFrame() {
        //北部的图片
        ImageIcon imageIcon = new ImageIcon(LoginView.class.getClassLoader().getResource("com/szz/images/Login.png"));
        ...
        loginButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (readerId > 0) {
                    ...
                    // TODO: 启动主界面
                    ADMSDemo admsDemo=new ADMSDemo();
